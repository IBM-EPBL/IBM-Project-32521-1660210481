...
def dashboard():
	...
	if output<0:
		return render_template('dash.html',prediction_texts="Sorry you cannot sell this car")
	return render_template('dash.html',prediction_text="You Can Sell The Car at {}".format(output))
